...
class TrainingPipeline:
    ...
    ## save artifacts and final model in AWS s3 bucket

    ## we are storing model in cloud because if the model is huge , then it is difficult to store in memory and also we can store multiple versions of models in cloud
    
    ## from local artifact directory it will push to aws s3 bucket
    ...
    ## local final model is pushed to AWS s3 bucket
